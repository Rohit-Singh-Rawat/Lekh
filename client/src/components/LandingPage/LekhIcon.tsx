...
const LekhIcon = ({width=200,height=100}: IconProps) => {
	return (
		<svg
			...
			width={width}
			height={height}
			viewBox='18.046848754882813 65.29812286376954 297.9063024902344 118.33375457763673'
		...
		>
			<g>
				...
				<g
					...
					transform='translate(26.967498779296875,74.21876907348633)'
				>
					<g
						className='iconsvg-imagesvg'
						transform='translate(0,0)'
						mask='url(#5e9745ca-0427-469c-8206-4fad5ca09605)'
					>
						<g>
							<rect
								fill='#2ebef3'
				...
				<defs v-gra='od'>
					<linearGradient
						...
						x2='0'
						y2='0'
						id='f5954334-9e60-4ac3-8736-237dcd16f005'
					>
						<stop
							offset='0%'
							stop-color='#5683f2'
				...
				<defs v-gra='id'>
					<filter
						id='af41ce6e-935e-4e9b-9432-036c97ca0c6c'
				...
				<mask
					v-gra='im'
					id='5e9745ca-0427-469c-8206-4fad5ca09605'
				>
					<g
						className='iconsvg-imagesvg'
						filter='url(#af41ce6e-935e-4e9b-9432-036c97ca0c6c)'
					>
						<g>
							<rect
								fill='#2ebef3'
